...
const SEGMENTOS = [
  ...
  { chave: "em_risco", nome: "Em risco", desc: "3 a 8 semanas sem pedir", fundo: "#FBE3DC", cor: "#8A2E1F",
    ideia: "Saudade: batata M",
    texto: "Oi, {nome}! Faz tempo que o {favorito} não sai daqui pra você 🐒 Até quinta, pedido a partir de R$ 50 leva *batata M de presente* com o cupom SAUDADE." },
  { chave: "aniversario_mes", nome: "Aniversariantes", desc: "fazem aniversário este mês", fundo: "#F3E6F7", cor: "#6A2C7A",
    ideia: "Niver: 4 pessoas, o seu é grátis",
    texto: "Oi, {nome}! A selva inteira sabe que esse mês é seu aniversário 🎉 Na semana do seu dia, vem com a galera: sendo 4 pessoas comendo lanche, *o seu sai de graça*. É só falar o cupom NIVER." },
  ...
  { chave: "perdido", nome: "Perdidos", desc: "mais de 2 meses sem pedir", fundo: "#ECEAE3", cor: "#4A574D",
    ...
    texto: "Oi, {nome}! Faz tempo que você não pede no Mr. Kong e a selva tá com saudade 🦍 Pra você voltar, qualquer pedido ganha *um Sagui de presente* até domingo com o cupom REI." },
  { chave: "cadastro", nome: "Só cadastro", desc: "cadastrados sem pedido recente", fundo: "#F1ECE0", cor: "#6B6758",
    ideia: "Convite: Quarta em dobro",
    texto: "Oi, {nome}! Você tem cadastro no Mr. Kong e ainda não fez seu primeiro pedido 🍔 Toda quarta tem *Quarta em dobro do Sagui*: qualquer sanduíche ganha um Sagui. Te esperamos!" },
