    ...
    <div style={{ position: "relative", flex: 1, minWidth: 170 }}>
      ...
      {aberto && (
        <div onMouseDown={(e) => e.preventDefault()}
          style={{ position: "absolute", left: 0, right: 0, top: "calc(100% + 4px)", zIndex: 40, background: "#FFFFFF", border: "1px solid #DDD5BF", borderRadius: 8, boxShadow: "0 8px 22px rgba(34,35,31,.14)", maxHeight: 210, overflowY: "auto" }}>
          {achados.map((i, idx) => (
