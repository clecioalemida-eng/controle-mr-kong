...
function PainelGerencia({ dias }) {
  // DIA OPERACIONAL, nao data de calendario, e nao UTC.
  //
  // Dois erros moravam nesta linha. `toISOString()` devolve UTC: das 21h
  // em diante (UTC-3) ela ja pedia o dia seguinte. E mesmo corrigido o
  // fuso, o resto da tela grava por dia operacional (17h -> 17h), entao
  // das 00h as 17h o painel pediria um dia que ainda nao comecou.
  //
  // Resultado: fora da janela das 17h as 21h, o painel mostrava
  // "NÃO FEZ" pra equipe inteira, inclusive pra quem tinha acabado de
  // preencher. Acusar quem fez e' pior que nao mostrar nada — destroi a
  // confianca na tela, e o time para de preencher.
            ...
            {lista.map((r) => {
              ...
              return (
                <div key={r.insumo_id} style={{
                  ...
                  {/* Mudar o setor do item é de QUALQUER pessoa aprovada desde
                      27/08/2026. Quem descobre que o alho está guardado na
                      cozinha e não na chapa é quem está contando, às 23h, com
                      o caderno na mão — e ter que chamar um administrador pra
                      isso é o que faz o cadastro ficar errado pra sempre.

                      Continua sendo mudança pequena e reversível: não mexe em
                      saldo nem em custo, só diz em que lista o item aparece.
                      O banco acompanha (migração 093). Dia já fechado continua
                      travado pra todo mundo. */}
                  {status !== "fechada" && (
                    <>
