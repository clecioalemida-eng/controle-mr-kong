...
const SEGMENTOS = [
  ...
  { chave: "cadastro", nome: "Só cadastro", desc: "cadastrados sem pedido recente", fundo: "#F1ECE0", cor: "#6B6758",
    ...
    texto: "Oi, {nome}! Você tem cadastro no Mr. Kong e ainda não provou o novo Kong: agora é só hambúrguer 🍔 Toda quarta tem *Quarta em dobro do Sagui*: qualquer sanduíche ganha um Sagui. Te esperamos!" },
